...
```{r scaling_plotting_functions, echo=F, eval=T}
...
```{r prior_predict_sigma, echo=TRUE, eval=TRUE}
...
level_order <-c("Host_Upham", "Host_name", "Virus_ICTV","Virus_name","PaperID")
re_dis <- re_intercepts_plot(re, level_order = level_order)
re_dis

ggsave("../plots_tables/hierarchical_effects_spec_dis_all.pdf", re_dis, height=3.5, width=6)                    
...
level_order <-c("Host_Upham", "Host_name", "Virus_ICTV","Virus_name","PaperID")
re_mort <- re_intercepts_plot(re, level_order = level_order)
re_mort

ggsave("../plots_tables/hierarchical_effects_spec_mort_all.pdf", re_mort, height=3.5, width=6)                    
...
level_order <-c("Host_Upham", "Host_name", "Virus_ICTV","Virus_name","PaperID")
re_severity <- re_intercepts_plot(re, level_order = level_order)
re_severity

ggsave("../plots_tables/hierarchical_effects_spec_mort_all.pdf", re_severity, height=3.5, width=6)                    
...
### Joint hierarchical effects plot (species level full model)

```{r joint_re_spec, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}

re_all_spec <- egg::ggarrange(
        (re_dis + 
        padding + 
        ggtitle("A) Disease presence")+
        ylab("Hierarchical predictors") +
        xlab("") +
        theme_bw() + 
...
ggsave("../plots_tables/hierarchical_effects_spec_all.pdf", re_all_spec, width=9, height=4)

```



## Species level models (reservoir match - no HEI)

### Presence of disease (reservoir match - no HEI)

```{r spec_disease_resMatch_alone, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}

if (!file.exists("../fit_models/spec_disease_resMatch_alone.rds")) {

  spec_disease_resMatch_alone <- brm(Disease_YN ~ Host_order + 
                      n_individuals +
                      Reservoir_match +  
                      ses_pd +
                      (1|PaperID) + 
  ...
  saveRDS(spec_disease_resMatch_alone, "../fit_models/spec_disease_resMatch_alone.rds")

} else { spec_disease_resMatch_alone <- readRDS("../fit_models/spec_disease_resMatch_alone.rds")}

model <- spec_disease_resMatch_alone
# summary(model, prob=0.9)

# save memory
rm(spec_disease_resMatch_alone)
...
# ggsave("../plots_tables/species_level_disease_resMatch_alone_comboplot.pdf", width=8, height=3)
...
### Mortality (reservoir match - no HEI)

```{r spec_mort_resMatch_alone, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}

if (!file.exists("../fit_models/spec_mort_resMatch_alone.rds")) {

  spec_mort_resMatch_alone <- brm(Mortality_YN ~ Host_order + 
                      n_individuals +
                      Reservoir_match + 
                      ses_pd +
                      (1|PaperID) + 
  ...
  saveRDS(spec_mort_resMatch_alone, "../fit_models/spec_mort_resMatch_alone.rds")

} else { spec_mort_resMatch_alone <- readRDS("../fit_models/spec_mort_resMatch_alone.rds")}

model <- spec_mort_resMatch_alone
# summary(model, prob=0.90)

# save memory
rm(spec_mort_resMatch_alone)
...
# ggsave("../plots_tables/species_level_mortality_resMatch_alone_comboplot.pdf", width=8, height=3)
...
### Severity (reservoir match - no HEI)

```{r spec_severity_resMatch_alone, echo=T, eval=T}

if (!file.exists("../fit_models/spec_severity_resMatch_alone.rds")) {

  spec_severity_resMatch_alone <- brm(severity_rank ~ Host_order + 
                      n_individuals +
                      Reservoir_match + 
                      ses_pd +
                      (1|PaperID) + 
  ...
  saveRDS(spec_severity_resMatch_alone, "../fit_models/spec_severity_resMatch_alone.rds")

} else { spec_severity_resMatch_alone <- readRDS("../fit_models/spec_severity_resMatch_alone.rds")}

model <- spec_severity_resMatch_alone
# summary(model, prob=0.90)

# save memory
rm(spec_severity_resMatch_alone)
...
### Joint results plots (species level reservoir match models - no HEI)

```{r joint_conditionals_intervals_plot_resMatch_alone, echo=T, eval=T, message=F, warning=F}
...
ggsave("../plots_tables/species_level_conditionals_intervals_resMatch_alone.pdf", joint_plot, width=10.5, height=5.5)
...
## Species level models (reservoir match - with HEI)


### Presence of disease (reservoir match - with HEI)
...
### Mortality (reservoir match - with HEI)
...
### Severity (reservoir match - with HEI)
...
### Joint results plots (species level reservoir match models - with HEI)
...
### Presence of disease (reservoir match - with HEI and removing Lyssaviruses)

```{r spec_disease_full_resMatch_nolys, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}

lyssaviruses <- viruses$Virus_ICTV[viruses$genus=="Lyssavirus"] %>% unique()
spec_nolys <- spec[!spec$Virus_ICTV%in%lyssaviruses,]

if (!file.exists("../fit_models/spec_disease_resMatch_nolys.rds")) {

  spec_disease_resMatch_nolys <- brm(Disease_YN ~ Host_order + n_individuals + 
                      Reservoir_match + ses_pd + EvoIso + 
                      (1|PaperID) + 
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV), 
  ...
  saveRDS(spec_disease_resMatch_nolys, "../fit_models/spec_disease_resMatch_nolys.rds")

} else { spec_disease_resMatch_nolys <- readRDS("../fit_models/spec_disease_resMatch_nolys.rds")}

model <- spec_disease_resMatch_nolys
# summary(model, prob=0.9)

# save memory
rm(spec_disease_resMatch_nolys)
...
plot_grid(p1, ar1, align="h", rel_widths =c(0.7,1))
# ggsave("../plots_tables/species_level_disease_resMatch_nolys_comboplot.pdf", width=8, height=3)
...
### Mortality (reservoir match - with HEI and removing lyssaviruses)

```{r spec_mort_full_resMatch_nolys, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}

if (!file.exists("../fit_models/spec_mort_resMatch_nolys.rds")) {

  spec_mort_resMatch_nolys <- brm(Mortality_YN ~ Host_order + n_individuals + 
                      Reservoir_match + ses_pd + EvoIso + 
                      (1|PaperID) + 
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV), 
  ...
  saveRDS(spec_mort_resMatch_nolys, "../fit_models/spec_mort_resMatch_nolys.rds")

} else { spec_mort_resMatch_nolys <- readRDS("../fit_models/spec_mort_resMatch_nolys.rds")}

model <- spec_mort_resMatch_nolys
# summary(model, prob=0.90)

# save memory
rm(spec_mort_resMatch_nolys)
...
# ggsave("../plots_tables/species_level_mortality_resMatch_nolys_comboplot.pdf", width=8, height=3)
...
### Severity (reservoir match - with HEI and removing lyssaviruses)

```{r spec_severity_full_resMatch_nolys, echo=T, eval=T}

if (!file.exists("../fit_models/spec_severity_resMatch_nolys.rds")) {

  spec_severity_resMatch_nolys <- brm(severity_rank ~ Host_order + n_individuals + 
                      Reservoir_match + ses_pd + EvoIso + 
                      (1|PaperID) + 
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV),  
  ...
  saveRDS(spec_severity_resMatch_nolys, "../fit_models/spec_severity_resMatch_nolys.rds")

} else { spec_severity_resMatch_nolys <- readRDS("../fit_models/spec_severity_resMatch_nolys.rds")}

model <- spec_severity_resMatch_nolys
# summary(model, prob=0.90)

# save memory
rm(spec_severity_resMatch_nolys)
...
# ggsave("../plots_tables/species_level_severity_resMatch_nolys_comboplot.pdf", width=8, height=3)
...
### Joint results plots (species level reservoir match models - with HEI and removing lyssaviruses)

```{r joint_conditionals_intervals_plot_resMatch_nolys, echo=T, eval=T, message=F, warning=F}
...
ggsave("../plots_tables/species_level_conditionals_intervals_resMatch_nolys.pdf", joint_plot, width=10.5, height=5.5)
...
## Species-level models (reservoir match x order interaction)


### Presence of disease (reservoir match x order interaction)

```{r spec_disease_resMatch_inter, echo=T, eval=T}

if (!file.exists("../fit_models/spec_disease_resMatch_inter.rds")) {

  disease_resMatch_inter <- brm(Disease_YN ~ Host_order * Reservoir_match + n_individuals +
                      ses_pd + EvoIso + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV), 
  ...
  saveRDS(disease_resMatch_inter, "../fit_models/spec_disease_resMatch_inter.rds")

} else { disease_resMatch_inter <- readRDS("../fit_models/spec_disease_resMatch_inter.rds")}

model <- disease_resMatch_inter
# summary(model, prob=0.9)

# save memory
rm(disease_resMatch_inter)
...
# test <- plot_conditional_effects(model, "Conditional probabilty of disease presence")
# test

ggsave("../plots_tables/spec_disease_resMatch_inter_cond_effs.pdf", width=6.5, height=5)


# ggsave("../plots_tables/spec_level_disease_resMatch_inter_comboplot.pdf", width=8, height=3)
...
### Mortality (reservoir match x order interaction)

```{r spec_mortality_resMatch_inter, echo=T, eval=T}

if (!file.exists("../fit_models/spec_mortality_resMatch_inter.rds")) {

  mortality_resMatch_inter <- brm(Mortality_YN ~ Host_order * Reservoir_match + n_individuals +
                      ses_pd + EvoIso +  
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV), 
  ...
  saveRDS(mortality_resMatch_inter, "../fit_models/spec_mortality_resMatch_inter.rds")

} else { mortality_resMatch_inter <- readRDS("../fit_models/spec_mortality_resMatch_inter.rds")}

model <- mortality_resMatch_inter
# summary(model, prob=0.9)

# save memory
rm(mortality_resMatch_inter)
...
# ggsave("../plots_tables/spec_level_mortality_resMatch_inter_comboplot.pdf", width=8, height=3)
...
### Severity (reservoir match x order interaction)

```{r spec_severity_resMatch_inter, echo=T, eval=T, message=F, warning=F}

if (!file.exists("../fit_models/spec_severity_resMatch_inter.rds")) {

  severity_resMatch_inter <- brm(severity_rank ~ Host_order * Reservoir_match + n_individuals +
                      ses_pd + EvoIso +  
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV), 
  ...
  saveRDS(severity_resMatch_inter, "../fit_models/spec_severity_resMatch_inter.rds")

} else { severity_resMatch_inter <- readRDS("../fit_models/spec_severity_resMatch_inter.rds")}

model <- severity_resMatch_inter
# summary(model, prob=0.9)

# save memory
rm(severity_resMatch_inter)
...
# ggsave("../plots_tables/spec_level_severity_resMatch_inter_comboplot.pdf", width=8, height=3)
...
### Joint results plots (reservoir match x order interaction)

```{r joint_conditionals_intervals_plot_spec_resMatch_inter, echo=T, eval=T, message=F, warning=F}
...
ggsave("../plots_tables/spec_level_conditionals_intervals_resMatch_inter.pdf", joint_plot, width=10.5, height=5.5)
...
## Species level models (only homologous hosts)

### Presence of disease (homologous hosts)

```{r spec_disease_homoHosts, echo=TRUE, eval=TRUE}

spec_homos <- spec[spec$Reservoir_match%in%1,]

if (!file.exists("../fit_models/spec_disease_homoHosts.rds")) {

  spec_disease_homos <- brm(Disease_YN ~ Host_order + n_individuals + 
                      ses_pd + EvoIso + 
                      (1|PaperID) + 
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV), 
    data=spec_homos, family=bernoulli(link = "logit"),
    prior=custom_prior,
    iter=5000, thin=1, cov_ranef = list(Host_Upham = host_cov, Virus_ICTV=virus_cov),
    control=list(adapt_delta=0.90, max_treedepth=10), cores=4, 
    save_pars=save_pars(all=TRUE))

  saveRDS(spec_disease_homos, "../fit_models/spec_disease_homoHosts.rds")

} else { spec_disease_homos <- readRDS("../fit_models/spec_disease_homoHosts.rds")}

model <- spec_disease_homos
# summary(model, prob=0.9)

# # save memory
rm(spec_disease_homos)
...
# ggsave("../plots_tables/species_level_disease_homoHosts_comboplot.pdf", width=8, height=3)
...
### Mortality (homologous hosts)

```{r spec_mort_homoHosts, echo=TRUE, eval=TRUE}

if (!file.exists("../fit_models/spec_mort_homoHosts.rds")) {

  spec_mort_homos <- brm(Mortality_YN ~ Host_order + n_individuals +  
                      ses_pd + EvoIso + 
                      (1|PaperID) + 
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV), 
  ...
  saveRDS(spec_mort_homos, "../fit_models/spec_mort_homoHosts.rds")

} else { spec_mort_homos <- readRDS("../fit_models/spec_mort_homoHosts.rds")}

model <- spec_mort_homos
# summary(model, prob=0.9)
...
# ggsave("../plots_tables/species_level_mortality_homoHosts_comboplot.pdf", width=8, height=3)
...
### Severity (homologous hosts)

```{r spec_severity_homoHosts, echo=T, eval=T}

if (!file.exists("../fit_models/spec_severity_homoHosts.rds")) {

  spec_severity_homos <- brm(severity_rank ~ Host_order + n_individuals +
                      ses_pd + EvoIso + 
                      (1|PaperID) + 
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV),  
    data=spec_homos, family=cumulative(probit), 
    prior=custom_prior,
    iter=5000, thin=1, cov_ranef = list(Host_Upham = host_cov, Virus_ICTV=virus_cov),
    control=list(adapt_delta=0.92, max_treedepth=10), cores=4, 
    save_pars=save_pars(all=TRUE))

  saveRDS(spec_severity_homos, "../fit_models/spec_severity_homoHosts.rds")

} else { spec_severity_homos <- readRDS("../fit_models/spec_severity_homoHosts.rds")}

# pairs(spec_severity_homos)
model <- spec_severity_homos
# summary(model, prob=0.9)

# save memory
rm(spec_severity_homos)
...
p3 <- cond_eff_plot(model) + scale_y_continuous(lim=c(-10,12)) + ylab("Conditional log-odds of severity") + 
      scale_x_discrete(limits = c("Chiroptera","Rodentia"))
...
# ggsave("../plots_tables/species_level_severity_homoHosts_comboplot.pdf", width=8, height=3)
...
### Joint results plots (homologous hosts)

```{r joint_conditionals_intervals_plot_homoHosts, echo=T, eval=T, message=F, warning=F}
...
ggsave("../plots_tables/species_level_conditionals_intervals_homoHosts.pdf", joint_plot, width=10.5, height=5.5)
...
dat_dose <- dat_dose %>% group_by(Dose_unit) %>% mutate(Dose_amount = log(Dose_amount))
dat_dose <- dat_dose %>% mutate(adult_mass_g = scale_half(log(adult_mass_g)))
...
# modelling mass adjusted dose differences
...
plot_grid(p1, ar1, align="h", rel_widths =c(0.7,1))
ggsave("../plots_tables/dose_g_comboplot.pdf", width=8, height=3)


# modelling daw dose differences

plot(dat_dose$Dose_amount, dat_dose$adult_mass_g)

if (!file.exists("../fit_models/dose_model_m2.rds")) {

  dose_m2 <- brm(Dose_amount ~ Host_order + adult_mass_g +
              (1|Dose_unit) +  (1|Route_type) + 
              (1|Host_name) + (1|Virus_name) +  
              (1|Host_Upham) + (1|Virus_ICTV), 
    data=dat_dose, family=gaussian(), 
  ...
  saveRDS(dose_m2, "../fit_models/dose_model_m2.rds")

} else { dose_m2 <- readRDS("../fit_models/dose_model_m2.rds")}

model <- dose_m2

# pp <- brms::posterior_predict(model)
# ppc_dens_overlay(y=model$data$Dose_amount, pp[1:500, ])

param_tab(model)

p1 <- cond_eff_plot(model) + scale_y_continuous(lim=c(-8,20)) + 
      ylab("Conditional log(dose)") + xlab("") + 
      theme(axis.title=element_text(size=9),axis.text.x=element_text(size=10)) + 
      scale_x_discrete(limits = c("Chiroptera","Rodentia"))
...
plot_grid(p1, ar1, align="h", rel_widths =c(0.7,1))
ggsave("../plots_tables/dose_amount_comboplot.pdf", width=8, height=3)


# modelling daw dose differences - no body mass included

if (!file.exists("../fit_models/dose_model_m3.rds")) {

  dose_m3 <- brm(Dose_amount ~ Host_order + 
              (1|Dose_unit) +  (1|Route_type) + 
              (1|PaperID) + 
              (1|Host_name) + (1|Virus_name) +  
              (1|Host_Upham) + (1|Virus_ICTV), 
  ...
  saveRDS(dose_m3, "../fit_models/dose_model_m3.rds")

} else { dose_m3 <- readRDS("../fit_models/dose_model_m3.rds")}
...
plot_grid(p1, ar1, align="h", rel_widths =c(0.7,1))
# ggsave("../plots_tables/dose_amount_nomass_comboplot.pdf", width=8, height=3)
...
dat_dis$adult_mass_g <- scale_half(log(dat_dis$adult_mass_g))

dat_dis <- dat_dis %>% group_by(Dose_unit) %>% mutate(Dose_mass = scale_half(log(Dose_mass)))
dat_dis <- dat_dis %>% group_by(Dose_unit) %>% mutate(Dose_amount = scale_half(log(Dose_amount)))
...
Full model adjusts for evolutionary predictors, dose/g, and inoculation route
...
dat_mort$adult_mass_g <- scale_half(log(dat_mort$adult_mass_g))

dat_mort <- dat_mort %>% group_by(Dose_unit) %>% mutate(Dose_mass = scale_half(log(Dose_mass)))
dat_mort <- dat_mort %>% group_by(Dose_unit) %>% mutate(Dose_amount = scale_half(log(Dose_amount)))
...
dat_severity$adult_mass_g <- scale_half(log(dat_severity$adult_mass_g))

dat_severity <- dat_severity %>% group_by(Dose_unit) %>% mutate(Dose_mass = scale_half(log(Dose_mass)))
dat_severity <- dat_severity %>% group_by(Dose_unit) %>% mutate(Dose_amount = scale_half(log(Dose_amount)))
...
model <- readRDS("../fit_models/indiv_disease_full.rds")

re <- ranef(model, probs=c(0.05, 0.25, 0.5, 0.75, 0.95))

level_order <-c("Host_Upham", "Host_name", "Virus_ICTV","Virus_name","Route_type","Dose_unit","PaperID")

re_dis <- re_intercepts_plot(re, level_order = level_order)
re_dis

ggsave("../plots_tables/hierarchical_effects_indiv_dis_all.pdf", re_dis, height=3.5, width=6)                    
...
model <- readRDS("../fit_models/indiv_mort_full.rds")
...
ggsave("../plots_tables/hierarchical_effects_indiv_mort_all.pdf", re_mort, height=3.5, width=6)                    
...
model <- readRDS("../fit_models/indiv_severity_full.rds")
...
ggsave("../plots_tables/hierarchical_effects_indiv_severity_all.pdf", re_severity, height=3.5, width=6)                    
...
### Joint hierarchical effects plot (individual level full model)

```{r joint_re_indiv, echo=TRUE, eval=TRUE, warning=FALSE, message=FALSE}

re_all_indiv <-  egg::ggarrange(
        (re_dis + 
        padding + 
        ggtitle("A) Disease presence")+
        ylab("Hierarchical predictors") +
...
ggsave("../plots_tables/hierarchical_effects_indiv_all.pdf", re_all_indiv, width=9, height=4)
...
## Individual level models (reservoir match - no HEI)


### Presence of disease (reservoir match - no HEI)

```{r indiv_disease_resMatch_alone, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_disease_resMatch_alone.rds")) {

  disease_resMatch_alone <- brm(Disease_YN ~ Host_order + 
                      Reservoir_match +
                      ses_pd +
                      Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
  ...
  saveRDS(disease_resMatch_alone, "../fit_models/indiv_disease_resMatch_alone.rds")

} else { disease_resMatch_alone <- readRDS("../fit_models/indiv_disease_resMatch_alone.rds")}

model <- disease_resMatch_alone
# summary(model, prob=0.9)

# save memory
rm(disease_resMatch_alone)
...
# ggsave("../plots_tables/individual_level_disease_resMatch_alone_comboplot.pdf", width=8, height=3)
...
```{r indiv_mortality_resMatch_alone, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_mortality_resMatch_alone.rds")) {

  mortality_resMatch_alone <- brm(Mortality_YN ~ Host_order + 
                      Reservoir_match +
                      ses_pd +
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
    ...
    prior=custom_prior,
    iter=5000, thin=1, cov_ranef = list(Host_Upham = host_cov, Virus_ICTV=virus_cov),
    control=list(adapt_delta=0.96, max_treedepth=12), cores=4, 
    save_pars=save_pars(all=TRUE))

  saveRDS(mortality_resMatch_alone, "../fit_models/indiv_mortality_resMatch_alone.rds")

} else { mortality_resMatch_alone <- readRDS("../fit_models/indiv_mortality_resMatch_alone.rds")}

model <- mortality_resMatch_alone
# summary(model, prob=0.9)

# save memory
rm(mortality_resMatch_alone)
...
# ggsave("../plots_tables/individual_level_mortality_resMatch_alone_comboplot.pdf", width=8, height=3)
...
```{r indiv_severity_resMatch_alone, echo=T, eval=T, message=F, warning=F}

if (!file.exists("../fit_models/indiv_severity_resMatch_alone.rds")) {

  severity_resMatch_alone <- brm(severity_rank ~ Host_order + 
                      Reservoir_match +
                      ses_pd +
                      Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
  ...
  saveRDS(severity_resMatch_alone, "../fit_models/indiv_severity_resMatch_alone.rds")

} else { severity_resMatch_alone <- readRDS("../fit_models/indiv_severity_resMatch_alone.rds")}

model <- severity_resMatch_alone
# summary(model, prob=0.9)

# save memory
rm(severity_resMatch_alone)
...
# ggsave("../plots_tables/individual_level_severity_resMatch_alone_comboplot.pdf", width=8, height=3)
...
### Joint results plots (reservoir match - no HEI)

```{r joint_conditionals_intervals_plot_indiv_resMatch_alone, echo=T, eval=T, message=F, warning=F}
...
ggsave("../plots_tables/individual_level_conditionals_intervals_resMatch_alone.pdf", joint_plot, width=10.5, height=5.5)

```



## Individual level models (reservoir match - with HEI)
...
### Joint results plots (reservoir match - with HEI)
...
## Individual level models (reservoir match x order interaction)


### Presence of disease (reservoir match x order interaction)

```{r indiv_disease_resMatch_inter, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_disease_resMatch_inter.rds")) {

  disease_resMatch_inter <- brm(Disease_YN ~ Host_order * Reservoir_match +
                      ses_pd + EvoIso +  
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
  ...
  saveRDS(disease_resMatch_inter, "../fit_models/indiv_disease_resMatch_inter.rds")

} else { disease_resMatch_inter <- readRDS("../fit_models/indiv_disease_resMatch_inter.rds")}
...
ggsave("../plots_tables/disease_resMatch_inter_cond_effs.pdf", width=6.5, height=5)


# ggsave("../plots_tables/individual_level_disease_resMatch_inter_comboplot.pdf", width=8, height=3)
...
```{r indiv_mortality_resMatch_inter, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_mortality_resMatch_inter.rds")) {

  mortality_resMatch_inter <- brm(Mortality_YN ~ Host_order * Reservoir_match +
                      ses_pd + EvoIso +  
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
  ...
  saveRDS(mortality_resMatch_inter, "../fit_models/indiv_mortality_resMatch_inter.rds")

} else { mortality_resMatch_inter <- readRDS("../fit_models/indiv_mortality_resMatch_inter.rds")}
...
# ggsave("../plots_tables/individual_level_mortality_resMatch_inter_comboplot.pdf", width=8, height=3)
...
```{r indiv_severity_resMatch_inter, echo=T, eval=T, message=F, warning=F}

if (!file.exists("../fit_models/indiv_severity_resMatch_inter.rds")) {

  severity_resMatch_inter <- brm(severity_rank ~ Host_order * Reservoir_match +
                      ses_pd + EvoIso +  
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
  ...
  saveRDS(severity_resMatch_inter, "../fit_models/indiv_severity_resMatch_inter.rds")

} else { severity_resMatch_inter <- readRDS("../fit_models/indiv_severity_resMatch_inter.rds")}
...
# ggsave("../plots_tables/individual_level_severity_resMatch_inter_comboplot.pdf", width=8, height=3)
...
```{r joint_conditionals_intervals_plot_indiv_resMatch_inter, echo=T, eval=T, message=F, warning=F}
...
ggsave("../plots_tables/individual_level_conditionals_intervals_resMatch_inter.pdf", joint_plot, width=10.5, height=5.5)

```


## Individual level models (reservoir match - with HEI and removing lyssaviruses)

### Presence of disease (reservoir match - with HEI and removing lyssaviruses)

```{r indiv_disease_resMatch_nolys, echo=T, eval=T}

lyssaviruses <- viruses$Virus_ICTV[viruses$genus=="Lyssavirus"] %>% unique()
dat_dis_nolys <- dat_dis[!dat_dis$Virus_ICTV%in%lyssaviruses,]

if (!file.exists("../fit_models/indiv_disease_resMatch_nolys.rds")) {

  disease_resMatch_nolys <- brm(Disease_YN ~ Host_order + Reservoir_match +
                      ses_pd + EvoIso +  
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
  ...
  saveRDS(disease_resMatch_nolys, "../fit_models/indiv_disease_resMatch_nolys.rds")

} else { disease_resMatch_nolys <- readRDS("../fit_models/indiv_disease_resMatch_nolys.rds")}

model <- disease_resMatch_nolys
# summary(model, prob=0.9)

# save memory
rm(disease_resMatch_nolys)
...
# ggsave("../plots_tables/individual_level_disease_resMatch_nolys_comboplot.pdf", width=8, height=3)
...
```{r indiv_mortality_resMatch_nolys, echo=T, eval=T}

lyssaviruses <- viruses$Virus_ICTV[viruses$genus=="Lyssavirus"] %>% unique()
dat_mort_nolys <- dat_mort[!dat_mort$Virus_ICTV%in%lyssaviruses,]

if (!file.exists("../fit_models/indiv_mortality_resMatch_nolys.rds")) {

  mortality_resMatch_nolys <- brm(Mortality_YN ~ Host_order + Reservoir_match +
                      ses_pd + EvoIso +  
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
  ...
  saveRDS(mortality_resMatch_nolys, "../fit_models/indiv_mortality_resMatch_nolys.rds")

} else { mortality_resMatch_nolys <- readRDS("../fit_models/indiv_mortality_resMatch_nolys.rds")}

model <- mortality_resMatch_nolys
# summary(model, prob=0.9)

# save memory
rm(mortality_resMatch_nolys)
...
p2 <- cond_eff_plot(model) + scale_y_continuous(lim=c(-15,10)) + 
      ylab("Conditional log-odds of mortality") + xlab("") + 
      theme(axis.title=element_text(size=9),axis.text.x=element_text(size=10)) + 
      scale_x_discrete(limits = c("Chiroptera","Rodentia"))
...
# ggsave("../plots_tables/individual_level_mortality_resMatch_nolys_comboplot.pdf", width=8, height=3)
...
```{r indiv_severity_resMatch_nolys, echo=T, eval=T, message=F, warning=F}

lyssaviruses <- viruses$Virus_ICTV[viruses$genus=="Lyssavirus"] %>% unique()
dat_severity_nolys <- dat_severity[!dat_severity$Virus_ICTV%in%lyssaviruses,]

if (!file.exists("../fit_models/indiv_severity_resMatch_nolys.rds")) {

  severity_resMatch_nolys <- brm(severity_rank ~ Host_order + Reservoir_match +
                      ses_pd + EvoIso +  
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
  ...
  saveRDS(severity_resMatch_nolys, "../fit_models/indiv_severity_resMatch_nolys.rds")


} else { severity_resMatch_nolys <- readRDS("../fit_models/indiv_severity_resMatch_nolys.rds")}

model <- severity_resMatch_nolys
# summary(model, prob=0.9)

# save memory
rm(severity_resMatch_nolys)
...
# ggsave("../plots_tables/individual_level_severity_resMatch_nolys_comboplot.pdf", width=8, height=3)
...
### Joint results plots (reservoir match - with HEI and removing lyssaviruses)

```{r joint_conditionals_intervals_plot_indiv_resMatch_nolys, echo=T, eval=T, message=F, warning=F}
...
ggsave("../plots_tables/individual_level_conditionals_intervals_resMatch_nolys.pdf", joint_plot, width=10.5, height=5.5)
...
## Individual level models (only homologous hosts)

### Presence of disease (homologous hosts)

```{r indiv_disaese_homos, echo=T, eval=T}

dat_dis_homos <- dat_dis[dat_dis$Reservoir_match%in%1,]

if (!file.exists("../fit_models/indiv_disease_homoHosts.rds")) {

  disease_homos <- brm(Disease_YN ~ Host_order +
                      ses_pd + EvoIso +  
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV) + 
                      (1|Route_type), 
    data=dat_dis_homos, family=bernoulli(link = "logit"), 
    prior=custom_prior,
    iter=5000, thin=1, cov_ranef = list(Host_Upham = host_cov, Virus_ICTV=virus_cov),
    control=list(adapt_delta=0.95, max_treedepth=12), cores=4, 
    save_pars=save_pars(all=TRUE))

  saveRDS(disease_homos, "../fit_models/indiv_disease_homoHosts.rds")

} else { disease_homos <- readRDS("../fit_models/indiv_disease_homoHosts.rds")}
...
# ggsave("../plots_tables/individual_level_disease_homoHosts_comboplot.pdf", width=8, height=3)
...
```{r indiv_mortality_homos, echo=T, eval=T}

dat_mort_homos <- dat_mort[dat_mort$Reservoir_match%in%1,]

if (!file.exists("../fit_models/indiv_mort_homoHosts.rds")) {

  mort_homos <- brm(Mortality_YN ~ Host_order  +
                      ses_pd + EvoIso +  
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV) + 
                      (1|Route_type), 
    data=dat_mort_homos, family=bernoulli(link = "logit"), 
    prior=custom_prior,
    iter=5000, thin=1, 
    cov_ranef = list(Host_Upham = host_cov, Virus_ICTV=virus_cov),
    control=list(adapt_delta=0.95, max_treedepth=12), cores=4, 
  ...
  saveRDS(mort_homos, "../fit_models/indiv_mort_homoHosts.rds")

} else { mort_homos <- readRDS("../fit_models/indiv_mort_homoHosts.rds")}
...
# ggsave("../plots_tables/individual_level_mortality_homoHosts_comboplot.pdf", width=8, height=3)
...
```{r indiv_severity_homos, echo=T, eval=T}

dat_severity_homos <- dat_severity[dat_severity$Reservoir_match%in%1,]

if (!file.exists("../fit_models/indiv_severity_homoHosts.rds")) {

  severity_homos <- brm(severity_rank ~ Host_order  +
                      ses_pd + EvoIso +  
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV) + 
                      (1|Route_type), 
    data=dat_severity_homos, family=cumulative(probit), 
    prior=custom_prior,
    iter=5000, thin=1, cov_ranef = list(Host_Upham = host_cov, Virus_ICTV=virus_cov),
    control=list(adapt_delta=0.98, max_treedepth=12), cores=4, 
    save_pars=save_pars(all=TRUE))

  saveRDS(severity_homos, "../fit_models/indiv_severity_homoHosts.rds")

} else { severity_homos <- readRDS("../fit_models/indiv_severity_homoHosts.rds")}

model <- severity_homos
# summary(model, prob=0.9)
...
p3 <- cond_eff_plot(model) + scale_y_continuous(lim=c(-8,10)) + 
      ylab("Conditional log-odds of severity") + xlab("") + 
      theme(axis.title=element_text(size=9),axis.text.x=element_text(size=10), 
            panel.grid.major = element_blank(), 
            panel.grid.minor = element_blank())+ 
...
# ggsave("../plots_tables/individual_level_severity_homoHosts_comboplot.pdf", width=8, height=3)

```
Sample size: `r nrow(model$data)`


### Joint results plots (individual level homologous host models)

```{r joint_conditionals_intervals_plot_indiv_homos, echo=T, eval=T, message=F, warning=F}

## Joint plot
global_ylim <-  scale_y_continuous(lim=c(-15,12)) 
padding <- theme(plot.margin = unit(c(t=0, r=-3, b=0, l=0), "cm"))

joint_plot <- joint_conditionals_intervals(p1,p2,p3,global_ylim,padding,ar1,ar2,ar3)

ggsave("../plots_tables/individual_level_conditionals_intervals_homoHosts.pdf", joint_plot, width=10.5, height=5.5)
...
## Individual level models (no body mass correction)


### Presence of disease - full model with dose uncorrected for body mass

```{r indiv_disease_dose_amount, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_disease_dose_amount.rds")) {

  disease_dose_amount <- brm(Disease_YN ~ Host_order + 
                      ses_pd + EvoIso +  
                       Dose_amount + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV) + 
                      (1|Route_type), 
  ...
  saveRDS(disease_dose_amount, "../fit_models/indiv_disease_dose_amount.rds")

} else { disease_dose_amount <- readRDS("../fit_models/indiv_disease_dose_amount.rds")}

model <- disease_dose_amount
# summary(model, prob=0.9)
...
plot_grid(p1, ar1, align="h", rel_widths =c(0.7,1))
# ggsave("../plots_tables/individual_level_disease_dose_amount_comboplot.pdf", width=8, height=3)
...
### Mortality - full model with dose uncorrected for body mass

```{r indiv_mortality_dose_amount, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_mort_dose_amount.rds")) {

  mort_dose_amount <- brm(Mortality_YN ~ Host_order +
                      ses_pd + EvoIso + 
                       Dose_amount + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
  ...
  saveRDS(mort_dose_amount, "../fit_models/indiv_mort_dose_amount.rds")

} else { mort_dose_amount <- readRDS("../fit_models/indiv_mort_dose_amount.rds")}

model <- mort_dose_amount
# summary(model, prob=0.9)

# save memory
rm(mort_dose_amount_mass)
...
plot_grid(p2, ar2, align="h", rel_widths =c(0.7,1))
# ggsave("../plots_tables/individual_level_mortality_dose_amount_comboplot.pdf", width=8, height=3)
...
### Severity - full model with dose uncorrected for body mass

```{r indiv_severity_dose_amount, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_severity_dose_amount.rds")) {

  severity_dose_amount <- brm(severity_rank ~ Host_order + 
                      ses_pd + EvoIso +  
                       Dose_amount + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
  ...
  saveRDS(severity_dose_amount, "../fit_models/indiv_severity_dose_amount.rds")

} else { severity_dose_amount <- readRDS("../fit_models/indiv_severity_dose_amount.rds")}

model <- severity_dose_amount
# summary(model, prob=0.9)

# save memory
rm(severity_dose_amount)
...
plot_grid(p3, ar3, align="h", rel_widths =c(0.7,1))
# ggsave("../plots_tables/individual_level_severity_dose_amount_comboplot.pdf", width=8, height=3)
...
### Joint results plots (individual level - dose uncorrected for body mass)

```{r joint_conditionals_intervals_plot_indiv_dos_amount, echo=T, eval=T, message=F, warning=F}
...
ggsave("../plots_tables/individual_level_conditionals_intervals_dose_amount.pdf", joint_plot, width=10.5, height=5.5)

```


## Individual level models (dose and body mass separate)

### Presence of disease - full model with dose and body mass (separate)

```{r indiv_disease_dose_amount_mass_separate, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_disease_dose_amount_mass.rds")) {

  disease_dose_amount_mass <- brm(Disease_YN ~ Host_order + 
                      ses_pd + EvoIso + adult_mass_g +  
                       Dose_amount + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV) + 
  ...
  saveRDS(disease_dose_amount_mass, "../fit_models/indiv_disease_dose_amount_mass.rds")

} else { disease_dose_amount_mass <- readRDS("../fit_models/indiv_disease_dose_amount_mass.rds")}

model <- disease_dose_amount_mass
# summary(model, prob=0.9)
...
### Mortality - full model with dose and body mass (separate)

```{r indiv_mortality_dose_amount_mass, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_mort_dose_amount_mass.rds")) {

  mort_dose_amount_mass <- brm(Mortality_YN ~ Host_order +
                      ses_pd + EvoIso + adult_mass_g +
                       Dose_amount + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
  ...
  saveRDS(mort_dose_amount_mass, "../fit_models/indiv_mort_dose_amount_mass.rds")

} else { mort_dose_amount_mass <- readRDS("../fit_models/indiv_mort_dose_amount_mass.rds")}

model <- mort_dose_amount_mass
# summary(model, prob=0.9)
...
# ggsave("../plots_tables/individual_level_mortality_dose_amount_mass_comboplot.pdf", width=8, height=3)
...
### Severity - full model with dose and body mass (separate)

```{r indiv_severity_dose_amount_mass, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_severity_dose_amount_mass.rds")) {

  severity_dose_amount_mass <- brm(severity_rank ~ Host_order + 
                      ses_pd + EvoIso +  adult_mass_g + 
                       Dose_amount + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
  ...
  saveRDS(severity_dose_amount_mass, "../fit_models/indiv_severity_dose_amount_mass.rds")

} else { severity_dose_amount_mass <- readRDS("../fit_models/indiv_severity_dose_amount_mass.rds")}

model <- severity_dose_amount_mass
# summary(model, prob=0.9)

# save memory
rm(severity_dose_amount_mass)
...
plot_grid(p3, ar3, align="h", rel_widths =c(0.7,1))
# ggsave("../plots_tables/individual_level_severity_dose_amount_mass_comboplot.pdf", width=8, height=3)
...
### Joint results plots (individual level - dose and body mass (separate))

```{r joint_conditionals_intervals_plot_indiv_dose_mass, echo=T, eval=T, message=F, warning=F}
...
ggsave("../plots_tables/individual_level_conditionals_intervals_dose_amount_mass.pdf", joint_plot, width=10.5, height=5.5)

```



## Individual level models - Removing inoculations into the brain


### Disease presence

```{r disease_no_brain_infections, echo=T, eval=T, message=F, warning=F}

dat_dis_nobrain <- dat_dis %>% filter(Route_type!="Injection (brain)")

if (!file.exists("../fit_models/indiv_disease_no_brain.rds")) {

  disease_no_brain <- brm(Disease_YN ~ Host_order + 
                      ses_pd + EvoIso + 
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV) + 
                      (1|Route_type), 
    data=dat_dis_nobrain, family=bernoulli(link = "logit"), 
    prior=custom_prior,
    iter=5000, thin=1, cov_ranef = list(Host_Upham = host_cov, Virus_ICTV=virus_cov),
    control=list(adapt_delta=0.99, max_treedepth=12), cores=4, 
    save_pars=save_pars(all=TRUE))

  saveRDS(disease_no_brain, "../fit_models/indiv_disease_no_brain.rds")

} else { disease_no_brain <- readRDS("../fit_models/indiv_disease_no_brain.rds")}

model <- disease_no_brain
# summary(model, prob=0.9)
...
p1 <- cond_eff_plot(model) + scale_y_continuous(lim=c(-12,12)) + 
      ylab("Conditional log-odds of disease presence") + xlab("") + 
      theme(axis.title=element_text(size=9),axis.text.x=element_text(size=10), 
            panel.grid.major = element_blank(), 
            panel.grid.minor = element_blank())+ 
      scale_x_discrete(limits = c("Chiroptera","Rodentia"))
...
```{r mortality_no_brain_infections, echo=T, eval=T, message=F, warning=F}

# Mortality

dat_mort_nobrain <- dat_mort %>% filter(Route_type!="Injection (brain)")

if (!file.exists("../fit_models/indiv_mort_no_brain.rds")) {

  mort_no_brain <- brm(Mortality_YN ~ Host_order + 
                      ses_pd + EvoIso + 
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV) + 
                      (1|Route_type), 
    data=dat_mort_nobrain, family=bernoulli(link = "logit"), 
    prior=custom_prior,
    iter=5000, thin=1, cov_ranef = list(Host_Upham = host_cov, Virus_ICTV=virus_cov),
    control=list(adapt_delta=0.99, max_treedepth=12), cores=4, 
    save_pars=save_pars(all=TRUE))

  saveRDS(mort_no_brain, "../fit_models/indiv_mort_no_brain.rds")

} else { mort_no_brain <- readRDS("../fit_models/indiv_mort_no_brain.rds")}
...
p2 <- cond_eff_plot(model) + scale_y_continuous(lim=c(-16,8)) + 
      ylab("Conditional log-odds of mortality") + xlab("") + 
      theme(axis.title=element_text(size=9),axis.text.x=element_text(size=10), 
            panel.grid.major = element_blank(), 
            panel.grid.minor = element_blank())+ 
...
```{r severity_no_brain_infections, echo=T, eval=T, message=F, warning=F}


dat_severity_nobrain <- dat_severity %>% filter(Route_type!="Injection (brain)")

if (!file.exists("../fit_models/indiv_severity_no_brain.rds")) {

  severity_no_brain <- brm(severity_rank ~ Host_order + 
                       ses_pd + EvoIso + 
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV) + 
                      (1|Route_type), 
    data=dat_severity_nobrain, family=cumulative(probit), 
    prior=custom_prior,
    iter=5000, thin=1, cov_ranef = list(Host_Upham = host_cov, Virus_ICTV=virus_cov),
    control=list(adapt_delta=0.99, max_treedepth=12), cores=4, 
    save_pars=save_pars(all=TRUE))

  saveRDS(severity_no_brain, "../fit_models/indiv_severity_no_brain.rds")

} else { severity_no_brain <- readRDS("../fit_models/indiv_severity_no_brain.rds")}

model <- severity_no_brain
# summary(model, prob=0.9)

# save memory
rm(severity_no_brain)
...
p3 <- cond_eff_plot(model) + scale_y_continuous(lim=c(-12,7)) + 
      ylab("Conditional log-odds of severity") + xlab("") + 
      theme(axis.title=element_text(size=9),axis.text.x=element_text(size=10), 
            panel.grid.major = element_blank(), 
            panel.grid.minor = element_blank())+ 
...
### Joint results plots (individual level models without brain inoculations)

```{r joint_conditionals_intervals_plot_indiv_bo_brain, echo=T, eval=T, message=F, warning=F}
...
ggsave("../plots_tables/individual_level_conditionals_intervals_no_brain.pdf", joint_plot, width=10.5, height=5.5)

```


## Individual level models - viruses inoculated into both orders


```{r viruses_both_orders_dat, echo=F, eval=T}
### Subset to viruses inoculated into both host orders

virus_subset <- intersect(dat$Virus_ICTV[dat$Host_order=="Chiroptera"], dat$Virus_ICTV[dat$Host_order=="Rodentia"] )

virus_subset #9 viruses

dat_viruses_both <- dat[dat$Virus_ICTV %in% virus_subset,]

dat_viruses_both <- dat_viruses_both[dat_viruses_both$Susceptible_YN==1,]
dat_viruses_both <- dat_viruses_both[!is.na(dat_viruses_both$Susceptible_YN),]

dat_viruses_both <- dat_viruses_both[!is.na(dat_viruses_both$Mortality_YN),]

dat_viruses_both$ses_pd <- scale_half(dat_viruses_both$ses_pd)
dat_viruses_both$EvoIso <- scale_half(dat_viruses_both$EvoIso)
dat_viruses_both$adult_mass_g <- scale_half(log(dat_viruses_both$adult_mass_g))

dat_viruses_both <- dat_viruses_both %>% group_by(Dose_unit) %>% mutate(Dose_mass = scale_half(log(Dose_mass)))
dat_viruses_both <- dat_viruses_both %>% group_by(Dose_unit) %>% mutate(Dose_amount = scale_half(log(Dose_amount)))

dat_viruses_both$Host_name <- dat_viruses_both$Host_Upham
dat_viruses_both$Virus_name <- dat_viruses_both$Virus_ICTV

# dim(dat_viruses_both)
# n_distinct(dat_viruses_both$PaperID)#42
# n_distinct(dat_viruses_both$Virus_ICTV)#8
# n_distinct(dat_viruses_both$Host_Upham)#41
# n_distinct(paste0(dat_viruses_both$Host_Upham, dat_viruses_both$Virus_ICTV))#47

# dat_viruses_both %>% ungroup() %>% select(c(Host_order, Host_Upham)) %>% unique() %>% 
#                       group_by(Host_order) %>% summarise(n_hosts=n_distinct(Host_Upham))
# Rodentia: 26
# Chiroptera: 15

# unique(dat_viruses_both$Virus_ICTV)

```


### Disease presence - viruses inoculated into both host orders

```{r disease_viruses_both_orders, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_disease_viruses_both_orders.rds")) {

  disease_viruses_both_orders <- brm(Disease_YN ~ Host_order + 
                      ses_pd + EvoIso + 
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV) + 
                      (1|Route_type), 
    data=dat_viruses_both, family=bernoulli(link = "logit"), 
    prior=custom_prior,
    iter=5000, thin=1, cov_ranef = list(Host_Upham = host_cov, Virus_ICTV=virus_cov),
    control=list(adapt_delta=0.99, max_treedepth=12), cores=4, 
    save_pars=save_pars(all=TRUE))

  saveRDS(disease_viruses_both_orders, "../fit_models/indiv_disease_viruses_both_orders.rds")

} else { disease_viruses_both_orders <- readRDS("../fit_models/indiv_disease_viruses_both_orders.rds")}

model <- disease_viruses_both_orders
# summary(model, prob=0.9)

# save memory
rm(disease_viruses_both_orders)
...
plot_grid(p1, ar1, align="h", rel_widths =c(0.7,1))
# ggsave("../plots_tables/individual_level_disease_viruses_both_orders.pdf", width=8, height=3)
...
### Mortality - viruses inoculated into both host orders

```{r mortality_viruses_both_orders, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_mort_viruses_both_orders.rds")) {

  mort_viruses_both_orders <- brm(Mortality_YN ~ Host_order + 
                      ses_pd + EvoIso + 
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
  ...
  saveRDS(mort_viruses_both_orders, "../fit_models/indiv_mort_viruses_both_orders.rds")

} else { mort_viruses_both_orders <- readRDS("../fit_models/indiv_mort_viruses_both_orders.rds")}

model <- mort_viruses_both_orders
# summary(model, prob=0.9)

# save memory
rm(mort_viruses_both_orders)
...
plot_grid(p2, ar2, align="h", rel_widths =c(0.7,1))
# ggsave("../plots_tables/individual_level_mort_viruses_both_orders.pdf", width=8, height=3)
...
### Severity - viruses inoculated into both host orders

```{r indiv_severity_viruses_both_orders, echo=T, eval=T}

if (!file.exists("../fit_models/indiv_severity_viruses_both_orders.rds")) {

  severity_viruses_both_orders <- brm(severity_rank ~ Host_order + 
                      ses_pd + EvoIso + 
                       Dose_mass + (1|Dose_unit) + 
                      (1|PaperID) +    
                      (1|Host_name) + (1|Virus_name) +
                      (1|Host_Upham) + (1|Virus_ICTV) + 
                      (1|Route_type), 
    data=dat_viruses_both, family=cumulative(probit), 
    prior=custom_prior,
    iter=5000, thin=1, cov_ranef = list(Host_Upham = host_cov, Virus_ICTV=virus_cov),
    control=list(adapt_delta=0.99, max_treedepth=12), cores=4, 
    save_pars=save_pars(all=TRUE))

  saveRDS(severity_viruses_both_orders, "../fit_models/indiv_severity_viruses_both_orders.rds")

} else { severity_viruses_both_orders <- readRDS("../fit_models/indiv_severity_viruses_both_orders.rds")}

model <- severity_viruses_both_orders
# summary(model, prob=0.9)

# save memory
rm(severity_viruses_both_orders)
...
plot_grid(p3, ar3, align="h", rel_widths =c(0.7,1))
# ggsave("../plots_tables/individual_level_severity_viruses_both_orders_comboplot.pdf", width=8, height=3)
...
### Joint results plots (individual level - viruses inoculated into both host orders)

```{r joint_conditionals_intervals_plot_indiv_viruses_both_host_orders, echo=T, eval=T, message=F, warning=F}
...
ggsave("../plots_tables/individual_level_conditionals_intervals_viruses_both_host_orders.pdf", joint_plot, width=10.5, height=5.5)
...
## mean CFR humans vs mean CFR bats/rodents


dat_meancfr <- dat %>% filter(Susceptible_YN==1) %>% select(PaperID, IndividualID, Virus_ICTV, Host_Upham, Host_order, Mortality_YN) %>% unique()

dat_meancfr <- dat_meancfr %>% filter(!is.na(IndividualID), !is.na(Mortality_YN))

dat_meancfr <- dat_meancfr %>% group_by(PaperID, Virus_ICTV, Host_Upham, Host_order) %>% 
                  summarise(n_mort=sum(Mortality_YN),n_indiv=n_distinct(IndividualID)) %>% unique()

dat_meancfr$exp_CFR <- dat_meancfr$n_mort/dat_meancfr$n_indiv

dat_meancfr <- left_join(dat_meancfr, unique(select(vtraits, c(Virus_ICTV, CFR_avg))))

dat_meancfr <- filter(dat_meancfr, !is.na(CFR_avg))

dat_meancfr$Host_order <- forcats::fct_relevel(dat_meancfr$Host_order, "Chiroptera", "Rodentia")



c3 <- ggplot(dat_meancfr, aes(y=CFR_avg, x=exp_CFR, shape=Host_order, color=Host_order)) +
              geom_jitter(size=3, alpha=0.4) + 
              scale_color_manual(values=colours_BR) + 
              labs(color="Host order", shape="Host order") + xlab("Infection-Fatality Rate in Inoculated Host") + ylab("Mean Case-Fatality Rate in Humans (%)") +
              theme_bw() + theme(
                        panel.grid.major.y=element_blank(),
                        panel.grid.minor.y=element_blank(),
                        panel.grid.major.x=element_blank(),
...
c3 <- c3 + coord_cartesian(clip = 'off') +   # This keeps the labels from disappearing
      theme(plot.margin = unit(c(1,1,1,1), "lines")) + 
        theme(legend.spacing = unit(1, "pt"), 
        legend.key.height = unit(14, "pt"), 
        legend.spacing.x = unit(5, "pt"), 
...
ggsave("../plots_tables/CFR_vs_IFR.pdf", width = 8.2, height = 5.25) 
